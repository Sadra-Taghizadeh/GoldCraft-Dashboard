...
<template>
  <VCard>
    ...
    <VCardText class="d-flex align-center justify-center pt-2 gap-4">
      ...
      >
        <span class="text-overline text-medium-emphasis">{{ tabData.profitLossAmount }}K Toman</span>
      </VProgressCircular>

      <div>
        <h6 class="text-base font-weight-regular">
          <span class="text-capitalize d-inline-block">{{ tabData.title }} this week</span>
        </h6>
